...
function NavBar({ title }) {
  ...
  return (
    <Fragment>
      <nav className="relative top-0 left-1/2 transform -translate-x-1/2 w-[390px] sm:w-[360px] py-[0px] z-50">
        <div className="z-50 py-4 px-6 pt-6 flex items-center justify-between top-0 backdrop-blur relative">
          ...
          <div className="left-6 flex items-center">
            <svg onClick={handleBack} className="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          {/* Centered Title */}
          <div className="absolute text-center left-1/2 transform -translate-x-1/2 text-white text-[25px] leading-[26px] uppercase font-semibold">
            {finalTitle}
          </div>
        </div>
      </nav>
